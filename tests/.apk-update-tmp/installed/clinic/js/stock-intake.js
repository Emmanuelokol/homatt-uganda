...
(function () {
  ...
  function ensure() {
    ...
    css.textContent = [
      ...
      '.stk-sum{margin-top:18px;padding:16px;border-radius:16px;background:var(--brand-tint);color:var(--primary-d)}',
      'html[data-theme="dark"] .stk-sum{background:rgba(18,163,116,.18);color:var(--brand-ink)}',
      ...
      '.stk-batch .lead{font-size:9.5px;font-weight:800;letter-spacing:.4px;background:var(--brand-tint);color:var(--primary-d);padding:2px 8px;border-radius:20px}',
      'html[data-theme="dark"] .stk-batch .lead{background:rgba(18,163,116,.22);color:var(--brand-ink)}',
