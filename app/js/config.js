...
// Inline fallback so navTo() is always available before native-bridge.js loads.
// native-bridge.js overwrites this with the full animated version.
window.navTo = window.navTo || function(url) { window.location.href = url; };
