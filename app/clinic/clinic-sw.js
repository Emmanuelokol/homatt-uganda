 ...
 */
const CACHE = 'homatt-clinic-v165';
...
const SHELL = [
  ...
  'messages.html',
  'guidelines.html',
  'js/guidelines.js?v=20260930',
  'js/vendor/sql-wasm.js',
  'js/ucg-autofill.js?v=20260930',
  'js/clinic-impression.js?v=20260930',
  'js/clinic-dictate.js?v=20260930',
  'js/clinic-speak.js?v=20260930',
  'js/clinic-intake.js?v=20260930',
  'js/clinic-look.js?v=20260930',
  'manifest.json',
  ...
  'css/clinic.css?v=20260930',
  'js/clinic.js?v=20260930',
  'js/messages.js?v=20260930',
  'js/clinic-offline.js?v=20260930a',
  'js/stock-blueprints.js?v=20260930',
  'js/stock-intake.js?v=20260930',
  'js/new-order-wizard.js?v=20260930',
  'js/msg-alerts.js?v=20260930',
  'js/pwa-install.js?v=20260930',
  '../js/config.js',
  '../js/native-bridge.js',
...
function offlineFallbackResponse() {
  ...
  var script =
    ...
    'async function healOnline(){var okAny=false;try{var ks=(await caches.keys()).filter(function(k){return k.indexOf("homatt-clinic-")===0;});if(!ks.length)ks=["homatt-clinic-v162"];for(var i=0;i<ks.length;i++){var c=await caches.open(ks[i]);var cs=core();for(var j=0;j<cs.length;j++){try{var r=await fetch(cs[j],{cache:"reload"});if(r&&r.ok&&!r.redirected){await c.put(cs[j],r.clone());okAny=true;}}catch(e){}}}}catch(e){}return okAny;}' +
    'async function run(){' +
